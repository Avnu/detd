...
class RunContext(AbstractContextManager):
    ...
    def __init__(self, mode, qdisc_exc=None, vlan_exc=None, device_exc=None, kernel_exc=None):
        ...
        if mode == TestMode.HOST:
            ...
            self.device_pci_id_mock = mock.patch.object(SystemInformation, 'get_pci_id', return_value=('8086:125D'))
            self.device_channels_mock = mock.patch.object(SystemInformation, 'get_channels_information', return_value=(4,4))
